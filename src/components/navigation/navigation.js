    ...
    return (
        <React.Fragment>
            <ul className="w-full grid text-center gap-8">
                ...
                <li><Link to={NavPath({path: "recitorsList"})} className="inline-block"><Microphone svgStyle={`w-8 aspect-square ${isCurrentPath('/audio') || isCurrentPath(`/audio/${author}`) ? 'text-teal-500' : 'text-gray-600'} hover:text-teal-500 transition duration-300`} strokeWidth="25" /></Link></li>
